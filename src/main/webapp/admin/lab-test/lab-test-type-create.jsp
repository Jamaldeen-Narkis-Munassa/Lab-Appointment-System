                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-md-end">
                                    <a href="lab-test-type-view.html" class="btn btn-primary mb-3">Back</a>
                                </div>
                            </div>
                            <hr>
                            <form>
                                ...
                                <!-- Name -->
                                <div class="mb-3">
                                    <label for="exampleInputPatientName" class="form-label">Test ID</label>
                                    <input type="text" class="form-control" id="exampleInputPatientName" placeholder="Enter Test ID">
                                </div>

                                <!-- Name -->
                                <div class="mb-3">
                                    <label for="exampleInputDoctorName" class="form-label">Test Name</label>
                                    <input type="text" class="form-control" id="exampleInputDoctorName" placeholder="Enter Test Name">
                                </div>

                                <!-- Name -->
                                <div class="mb-3">
                                    <label for="exampleInputTestType" class="form-label">Discription</label>
                                    <input type="text" class="form-control" id="exampleInputTestType" placeholder="Enter Discription">
                                </div>
