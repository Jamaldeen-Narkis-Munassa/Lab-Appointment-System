  ...
  <div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-child me-2"></i>Patient</a>
              <div class="dropdown-menu bg-transparent border-0">
                  <a href="../../admin/patient/patient-view.jsp" class="dropdown-item active">View Patient</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-md-end">
                                    <a href="patient-create.jsp" class="btn btn-primary mb-3">Create</a>
                                </div>
                            </div>
                            <hr class="mb-5">
