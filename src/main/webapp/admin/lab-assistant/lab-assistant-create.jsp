  ...
  <div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-user-nurse me-2"></i>Lab Assistant</a>
              <div class="dropdown-menu bg-transparent border-0">
                  <a href="../../admin/lab-assistant/lab-assistant-view.html" class="dropdown-item active">View Lab Assistant</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <h4 class="mb-0">Create Lab Assistant</h4>
                                </div>
                                <div class="col-md-6 text-md-end">
                                    <a href="lab-assistant-view.html" class="btn btn-primary mb-3">Back</a>
                                </div>
                            </div>
                            <hr>
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your First name">
                                </div>
                                <!-- LastName -->
                                <div class="mb-3">
                                    <label for="exampleInputName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="exampleInputName" placeholder="Enter your Last name">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter your NIC">
                                </div>
