                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-md-end">
                                    <a href="doctor-view.html" class="btn btn-primary mb-3">Back</a>
                                </div>
                            </div>
                            <hr>
                            <form>
                                ...
                                <!-- LastName -->
                                <div class="mb-3">
                                    <label for="exampleInpuLasttName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="exampleInpuLasttName" placeholder="Enter your Last name">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputSpecialization" placeholder="Enter Specialization">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputYear" class="form-label">Experience Year</label>
                                    <input type="number" class="form-control" id="exampleInputYear" placeholder="Enter Experience Year">
                                </div>

                                <!-- Password -->
                                <div class="mb-3">
                                    <label for="exampleInputID" class="form-label">SLMC ID</label>
                                    <input type="number" class="form-control" id="exampleInputID" placeholder="Enter SLMC ID">
                                </div>

                                <!-- Address -->
                                <div class="mb-3">
                                    <label for="exampleInputAddress" class="form-label">Address</label>
                                    <input type="number" class="form-control" id="exampleInputAddress" placeholder="Enter Address">
                                </div>
